...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : tsk_c0_100ms_task.c Module File.                           |
|                                                                             |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_100MS_init                                  |
|                                                                             |
|    Description       :  Function to initialize Core 0 - 100ms task          |
|                                                                             |
|    Inputs            :  none.                                               |
|                                                                             |
|    Outputs           :  none.                                               |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_100MS                                       |
|                                                                             |
|    Description       :  Core 0 - 100ms task                                 |
|                                                                             |
...
void task_C0_100MS( void *params )
{
	portBaseType ok;
	...
	for ( ;; )
	{
		...
		( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "task_C0_100MS - Serial Debug Queue Error: %d\r\n", ok ) ) );
#endif
		...
		//?? ( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "Task overrun: 100ms\r\n" ) ) );

#if 0
		printf( "C0 100ms task callcount: %d\r\n", procdata->callcount );
#endif
...
/*----------------------------------------------------------------------------\
|   End of tsk_C0_100ms_task.c Module                                         |
\----------------------------------------------------------------------------*/
