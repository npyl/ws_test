...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : tsk_c0_500ms_task.c Module File.                           |
|                                                                             |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_500MS_init                                  |
|                                                                             |
|    Description       :  Function to initialize Core 0 - 500ms task          |
|                                                                             |
|    Inputs            :  none.                                               |
|                                                                             |
|    Outputs           :  none.                                               |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_500MS                                       |
|                                                                             |
|    Description       :  Core 0 - 500ms task                                 |
|                                                                             |
...
void task_C0_500MS( void *params )
{
	portBaseType ok;
	...
	for ( ;; )
	{
		...
		( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "task_C0_500MS - Serial Debug Queue Error: %d\r\n", ok ) ) );
#endif
		...
		//?? ( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "Task overrun: 500ms\r\n" ) ) );

#if 0
		printf( "C0 500ms task callcount: %d\r\n", procdata->callcount );
#endif
...
/*----------------------------------------------------------------------------\
|   End of tsk_C0_500ms_task.c Module                                         |
\----------------------------------------------------------------------------*/
