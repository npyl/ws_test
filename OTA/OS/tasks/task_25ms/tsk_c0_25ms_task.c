...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : tsk_c0_25ms_task.c Module File.                            |
|                                                                             |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_25MS_init                                   |
|                                                                             |
|    Description       :  Function to initialize Core 0 - 25ms task           |
|                                                                             |
|    Inputs            :  none.                                               |
|                                                                             |
|    Outputs           :  none.                                               |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_25MS                                        |
|                                                                             |
|    Description       :  Core 0 - 25ms task                                  |
|                                                                             |
...
void task_C0_25MS( void *params )
{
	...
	for ( ;; )
	{
		...
		/*
         * !!! Caution !!!
         * No point sending serial debug info to gatekeeper task that runs every 25ms.
		...
		( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "task_C0_25MS - Serial Debug Queue Error: %d\r\n", ok ) ) );
#endif
		...
		//?? ( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "Task overrun: 25ms\r\n" ) ) );

#if 0
		printf( "C0 25ms task callcount: %d\r\n", procdata->callcount );
#endif
...
/*----------------------------------------------------------------------------\
|   End of tsk_C0_25ms_task.c Module                                          |
\----------------------------------------------------------------------------*/
