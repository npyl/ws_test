...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : tsk_c0_2ms_task.c Module File.                             |
|                                                                             |
...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Application tsk_c0_2ms_task.c Module                                      |
|                                                                             |
\----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_2MS_init                                    |
|                                                                             |
|    Description       :  Function to initialize Core 0 - 2ms task            |
|                                                                             |
|    Inputs            :  none.                                               |
|                                                                             |
|    Outputs           :  none.                                               |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_2MS                                         |
|                                                                             |
|    Description       :  Core 0 - 2ms task                                   |
|                                                                             |
...
void task_C0_2MS( void *params )
{
	...
	for ( ;; )
	{
#if 0
		/*
         * No point sending serial debug info to gatekeeper task that runs every 2ms.
		...
		( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "task_C0_2MS - Serial Debug Queue Error: %d\r\n", ok ) ) );
#endif
		...
		//?? ( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "Task overrun: 2ms\r\n" ) ) );

#if 0
		printf( "C0 2ms task callcount: %d\r\n", procdata->callcount );
#endif
...
/*----------------------------------------------------------------------------\
|   End of tsk_C0_2ms_task.c Module                                           |
\----------------------------------------------------------------------------*/
