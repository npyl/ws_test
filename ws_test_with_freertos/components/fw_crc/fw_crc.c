...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : fw_crc.c Module File.                                      |
|                                                                             |
...
|   Procedure           : crc32                                               |
|                                                                             |
|   Description         : This function calculates MIT standard CRC32 value   |
|                         Can verify at: https://crccalc.com/                 |
|                                                                             |
|   Inputs              : Pointer to a data array.                            |
