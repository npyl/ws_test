...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : tsk_c0_10ms_task.c Module File.                            |
|                                                                             |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_10MS_init                                   |
|                                                                             |
|    Description       :  Function to initialize Core 0 - 10ms task           |
|                                                                             |
|    Inputs            :  none.                                               |
|                                                                             |
|    Outputs           :  none.                                               |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_10MS                                        |
|                                                                             |
|    Description       :  Core 0 - 10ms task                                  |
|                                                                             |
...
void task_C0_10MS( void *params )
{
	...
	for ( ;; )
	{
		...
		/*
		 * !!! Caution !!!
         * No point sending serial debug info to gatekeeper task that runs every 10ms.
		...
		( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "task_C0_10MS - Serial Debug Queue Error: %d\r\n", ok ) ) );
#endif
		...
		//?? ( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "Task overrun: 10ms\r\n" ) ) );

#if 0
		printf( "C0 10ms task callcount: %d\r\n", procdata->callcount );
#endif
...
/*----------------------------------------------------------------------------\
|   End of tsk_c0_10ms_task.c Module                                          |
\----------------------------------------------------------------------------*/
