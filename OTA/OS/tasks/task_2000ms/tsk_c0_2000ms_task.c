...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Module Name  : tsk_c0_2000ms_task.c Module File.                          |
|                                                                             |
...
|-----------------------------------------------------------------------------|
|                                                                             |
|   Application 2000ms task Module                                            |
|                                                                             |
\----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_2000MS_init                                 |
|                                                                             |
|    Description       :  Function to initialize Core 0 - 2000ms task         |
|                                                                             |
|    Inputs            :  none.                                               |
|                                                                             |
|    Outputs           :  none.                                               |
...
/*----------------------------------------------------------------------------\
|                                                                             |
|    Procedure         :  task_C0_2000MS                                      |
|                                                                             |
|    Description       :  Core 0 - 2000ms task                                |
|                                                                             |
...
void task_C0_2000MS( void *params )
{
	portBaseType ok;
	...
	for ( ;; )
	{
		...
		( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "task_C0_2000MS - Serial Debug Queue Error: %d\r\n", ok ) ) );
#endif
		...
		//?? ( ( ok == pdPASS ) ? ( { __asm volatile ( " nop" ); } ) : ( printf( "Task overrun: 2000ms\r\n" ) ) );

#if 0
		printf( "C0 2000ms task callcount: %d\r\n", procdata->callcount );
#endif
...
/*----------------------------------------------------------------------------\
|   End of tsk_C0_2000ms_task.c Module                                                  |
\----------------------------------------------------------------------------*/
